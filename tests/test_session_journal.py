...
os.environ.setdefault("CONTAINER_NAME", "okx_strangle_eth")
...
def test_opened_then_booked_fills_pnl():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        rec.outcome(
            "opened", intent="buy",
            qty_per_leg=30.0, strike=2600,
            call_symbol="ETH-USD-260821-2600-C",
            put_symbol="ETH-USD-260821-2580-P",
        )
